...
function nextVideo() {
  // Increment the current video index and ensure it stays within bounds
  currentVideoIndex = (currentVideoIndex + 1) % videoFiles.length;

  // Get the video element
  const video = document.getElementById('currentVideo');

  // Change the video source to the next video file and play the new video
...
function previousVideo() {
  // Decrement the current video index and ensure it stays within bounds
  currentVideoIndex = (currentVideoIndex - 1 + videoFiles.length) % videoFiles.length;

  // Get the video element
  const video = document.getElementById('currentVideo');

  // Change the video source to the previous video file and play the new video
  video.src = videoFiles[currentVideoIndex];
  video.play();
}
